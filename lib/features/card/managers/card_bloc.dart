...
class PaymentBloc extends Bloc<PaymentEvent, PaymentState> {
  ...
  Future<void> _onLoadCards(LoadCardsEvent event, Emitter<PaymentState> emit) async {
    ...
    result.fold(
      onError: (e) {
        ...
        emit(PaymentError('Failed to load cards: $e'));
      },
      onSuccess: (cards) {
  ...
  Future<void> _onAddCard(AddCardEvent event, Emitter<PaymentState> emit) async {
      ...
      onSuccess: (newCard) async {
        ...
        cardsResult.fold(
          onError: (e) {
            ...
            emit(PaymentError('Failed to refresh cards: $e'));
          },
          onSuccess: (cards) {
  ...
  Future<void> _onDeleteCard(DeleteCardEvent event, Emitter<PaymentState> emit) async {
